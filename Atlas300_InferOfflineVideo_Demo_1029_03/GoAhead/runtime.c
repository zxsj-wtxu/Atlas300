...
static void outNum(Format *fmt, char *prefix, unsigned long long int val);
        ...
        case STATE_TYPE:
            ...
            case 'd':
                ...
                if (fmt.flags & SPRINTF_SHORT) {
                    ...
                    iValue = (long long int) va_arg(args, long long int);
                } else {
            ...
            case 'u':
                if (fmt.flags & SPRINTF_SHORT) {
                    ...
                    uValue = (unsigned long long int) va_arg(args, unsigned long long int);
                } else {
            ...
            case 'p':       /* Pointer */
#if ME_64
                uValue = (unsigned long long int) va_arg(args, void*);
#else
...
static void outNum(Format *fmt, char *prefix, unsigned long long int value)
{
    char    numBuf[64];
    char    *cp;
    char    *endp;
