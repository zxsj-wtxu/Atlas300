 ...
 */
#if ME_64
    #define ITOP(i)     ((void*) ((long long int) i))
    #define PTOI(i)     ((int) ((long long int) i))
    #define LTOP(i)     ((void*) ((long long int) i))
    #define PTOL(i)     ((long long int) i)
#else
    #define ITOP(i)     ((void*) ((int) i))
    #define PTOI(i)     ((int) i)
    #define LTOP(i)     ((void*) ((int) i))
    #define PTOL(i)     ((long long int) (int) i)
#endif
