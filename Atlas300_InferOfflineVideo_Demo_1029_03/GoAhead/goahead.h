...
#define SOCKET_RESERVICE        0x4     /**< SocketFd needs re-servicing */
#define SOCKET_ASYNC            0x8     /**< Use async connect */
#define SOCKET_BLOCK            0x10    /**< Use blocking I/O */
#define SOCKET_LISTENING        0x20    /**< SocketFd is server listener */
#define SOCKET_CLOSING          0x40    /**< SocketFd is closing */
#define SOCKET_CONNRESET        0x80    /**< SocketFd connection was reset */
...
/*
    SocketFd error values
 */
#define SOCKET_WOULDBLOCK       1       /**< SocketFd would block on I/O */
#define SOCKET_RESET            2       /**< SocketFd has been reset */
...
/**
    SocketFd I/O callback
    @param sid SocketFd ID handle returned from socketConnect or when a new socket is passed to a SocketAccept
        callback..
...
/**
    SocketFd accept callback
    @param sid SocketFd ID handle for the newly accepted socket
    @param ipaddr IP address of the connecting client.
    @param port Port of the connecting client.
    @param listenSid SocketFd ID for the listening socket
    @ingroup WebsSocket
    @stability Stable
 */
...
typedef struct WebsSocket {
    ...
    SocketFd          sock;               /**< Actual socket handle */
    ...
    int             secure;             /**< SocketFd is using SSL */
...
/**
    ...
    @param port SocketFd port
    @param accept Optional SocketAccept accept callback function
    @param flags Control flags
    @return SocketFd ID handle to use with other APIs.
    @ingroup WebsSocket
    @stability Stable
 */
...
/**
    ...
    @param sid SocketFd ID handle returned from socketConnect or socketAccept.
    @ingroup WebsSocket
    @stability Stable
 */
...
/**
    ...
    @param sid SocketFd ID handle returned from socketConnect or socketAccept.
    @param mask Mask of events of interest. Set to SOCKET_READABLE | SOCKET_WRITABLE | SOCKET_EXCEPTION.
    @param handler SocketFd handler function.
...
/**
    ...
    @stability Stable
 */
PUBLIC SocketFd socketGetHandle(int sid);
...
/**
    ...
    @param sp SocketFd object returned from #socketPtr
...
typedef struct Webs {
    ...
    int             sid;                /**< SocketFd id (handler) */
    int             listenSid;          /**< Listen SocketFd id */
...
/**
    ...
    @param listenSid SocketFd ID of the listening socket
    @return Zero if successful, otherwise -1
    @ingroup Webs
    @stability Stable
 */
...
/**
    ...
    @return Positive integer holding a SocketFd ID handle if successful, otherwise -1.
    @ingroup Webs
    @stability Stable
 */
