...
namespace hiai {
    ...
    class HIAILog {
      public:
        ...
        * @ingroup hiaiengine
        * @brief : 是否初始化
        * @return : 返回true如果已经初始化，否则返回false
        */
        ...
        * @brief 刷新日志级别
        */
        HIAI_LIB_INTERNAL void HIAIRefreshLogLevel();
...
HIAI_LIB_INTERNAL void HIAI_ENGINE_LOG_IMPL(const char* funcPointer,
    ...
    const hiai::GraphImpl* graph, const uint32_t errorCode, const char* format, ...);
...
HIAI_LIB_VISIBILITY void HIAI_ENGINE_LOG_IMPL(const char* funcPointer,
    const char* filePath, int32_t lineNumber,
    const hiai::Graph* graph, const uint32_t errorCode, const char* format, ...);
...
HIAI_LIB_VISIBILITY void HIAI_ENGINE_LOG_IMPL(const char* funcPointer,
    const char* filePath, int32_t lineNumber,
    const hiai::Engine* engine, const uint32_t errorCode, const char* format, ...);
...
HIAI_LIB_INTERNAL void HIAI_ENGINE_LOG_IMPL(const char* funcPointer,
    const char* filePath, int32_t lineNumber,
    const int32_t moudleID, const hiai::GraphImpl* graphImpl,
    const uint32_t errorCode, const char* format, ...);
...
HIAI_LIB_VISIBILITY void HIAI_ENGINE_LOG_IMPL(const char* funcPointer,
    const char* filePath, int32_t lineNumber,
    const int32_t moudleID, const hiai::Graph* graph,
    const uint32_t errorCode, const char* format, ...);
...
HIAI_LIB_VISIBILITY void HIAI_ENGINE_LOG_IMPL(const char* funcPointer,
    const char* filePath, int32_t lineNumber,
    const int32_t moudleID, const hiai::Engine* engine, const uint32_t errorCode,
    const char* format, ...);
