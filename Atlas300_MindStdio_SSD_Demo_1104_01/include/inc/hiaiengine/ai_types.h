...
// 定义相关宏，对相关函数符号进行屏蔽
#ifndef HIAI_NODE_LIB_VISIBILITY
    #if !(defined _WIN32) && !(defined __CYGWIN__)
        #define HIAI_NODE_LIB_VISIBILITY __attribute__ ((visibility ("default"))) //__declspec(dllexport)
    #else
        #define HIAI_NODE_LIB_VISIBILITY
    #endif
#endif
