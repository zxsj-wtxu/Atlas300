...
/**
 * @brief fusion start
 * @param [in] ddk_ver                ddk version of op
 * @param [in] opName                 te op name of graph
 * @param [in] opModule               te python op module
 * @param [in] opFuncName             te python op function name
 * @param [in] format                 te op args format
 * @param [in] args                   te op args
 * @return [out] bool                 succ or fail of building single op
 */
bool BuildTeCustomOp(std::string ddk_ver, std::string opName, std::string opModule, std::string opFuncName,
                     const char *format, ...);
